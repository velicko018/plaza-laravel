            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mg-avl-room">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <a class="btn btn-dark">View Details <i class="fa fa-angle-double-right"></i></a>
                                <a class="btn btn-main pull-right">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="mg-avl-room">
                    ...
                    <div class="mg-avl-room">
                        <div class="row">
                            <div class="col-sm-5">
                                <a href="#"><img src="{!! asset('images/room-4.png') !!}" alt="" class="img-responsive"></a>
                            </div>
                            <div class="col-sm-7">
                                <h3 class="mg-avl-room-title"><a href="#">Super Deluxe</a> <span>$249<sup>.99</sup>/Night</span></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia minuti firme desperantes vix sempiternum sentiri possunt, philosophia permanentes, sentit careret.</p>
